...
export function CierresPage() {
  const [tab, setTab] = useState<'caja' | 'dia' | 'mes'>('caja')
  ...
  return (
    <div className="panel">
      ...
      <div className="caja-tabs">
        <button className={tab === 'caja' ? 'primary' : ''} onClick={() => setTab('caja')}>
          Cierres por caja
        </button>
        <button className={tab === 'dia' ? 'primary' : ''} onClick={() => setTab('dia')}>
          Por día
        </button>
        <button className={tab === 'mes' ? 'primary' : ''} onClick={() => setTab('mes')}>
          Por mes
        </button>
      </div>
